...
# found at https://github.com/tamaggo/gstreamer-examples/blob/master/test_gst_rtsp_server.py
import sys
import gi
...
class MyFactory(GstRtspServer.RTSPMediaFactory):
	...
	def do_create_element(self, url):
		s_src = "videotestsrc ! video/x-raw,rate=30,width=320,height=240 ! videoconvert ! video/x-raw,format=I420"
